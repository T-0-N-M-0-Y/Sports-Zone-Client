            ...
            <div className="carousel md:w-full h-96 md:h-screen">
                <div id="slide1" className="carousel-item relative w-full">
                    ...
                    <div className="absolute flex justify-between items-center transform -translate-y-1/2 left-5 right-5 top-1/2">
                        ...
                        <p className="md:text-5xl text-xs md:font-bold text-white bg-black p-2 md:p-5 bg-opacity-40">Enjoy Your Summer With Sports!!! <br /> Winning isn’t everything, but wanting is!!! <br /> <button className="hover:bg-orange-800 bg-orange-500 hover:text-white border-none mt-2 p-2 text-xs md:text-sm rounded-lg w-20 md:w-32">Enroll Now</button></p>
                ...
                <div id="slide2" className="carousel-item relative w-full">
                    ...
                    <div className="absolute flex justify-between items-center transform -translate-y-1/2 left-5 right-5 top-1/2">
                        ...
                        <p className="md:text-5xl text-xs md:font-bold text-white bg-black p-2 md:p-5 bg-opacity-40">Heading to the top!!! <br /> Pain is temporary. Victory is forever.!!! <br /> <button className="hover:bg-orange-800 bg-orange-500 hover:text-white border-none mt-2 p-2 text-xs md:text-sm rounded-lg w-20 md:w-32">Enroll Now</button></p>
                ...
                <div id="slide3" className="carousel-item relative w-full">
                    ...
                    <div className="absolute flex justify-between items-center transform -translate-y-1/2 left-5 right-5 top-1/2">
                        <a href="#slide2" className="btn btn-circle hover:bg-orange-800 bg-orange-500 hover:text-white border-none w-4 h-4">❮</a>
                        <p className="md:text-5xl text-xs md:font-bold text-white bg-black p-2 md:p-5 bg-opacity-40">You develop your skills as you beat hours and hours of practice.!!! <br /> Taking your game to the next level!!! <br /> <button className="hover:bg-orange-800 bg-orange-500 hover:text-white border-none mt-2 p-2 text-xs md:text-sm rounded-lg w-20 md:w-32">Enroll Now</button></p>
                        <a href="#slide4" className="btn btn-circle hover:bg-orange-800 bg-orange-500 hover:text-white border-none w-4 h-4">❯</a>
                    </div>
                </div>
                <div id="slide4" className="carousel-item relative w-full">
                    ...
                    <div className="absolute flex justify-between items-center transform -translate-y-1/2 left-5 right-5 top-1/2">
                        <a href="#slide3" className="btn btn-circle hover:bg-orange-800 bg-orange-500 hover:text-white border-none w-4 h-4">❮</a>
                        <p className="md:text-5xl text-xs md:font-bold text-white bg-black p-2 md:p-5 bg-opacity-40">Unleash the best athlete in you!!! <br /> Never doubt yourself!!! <br /> <button className="hover:bg-orange-800 bg-orange-500 hover:text-white border-none mt-2 p-2 text-xs md:text-sm rounded-lg w-20 md:w-32">Enroll Now</button></p>
                        <a href="#slide1" className="btn btn-circle hover:bg-orange-800 bg-orange-500 hover:text-white border-none w-4 h-4">❯</a>
                    </div>
                </div>
            </div>
